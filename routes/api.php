...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['middleware' => ['hasToken:ALL_DOC_WATERMARK,ASSIGNED_DOC_WATERMARK']], function () {
        Route::post('/document-watermark', [DocumentWatermarkController::class, 'watermarkDocument']);
    });
});
